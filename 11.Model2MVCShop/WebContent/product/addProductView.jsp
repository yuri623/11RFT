...
<!-- <table width="100%" height="37" border="0" cellspacing="0" cellpadding="0">
	...
	<div class="form-group">
		    <label for="manuDate" class="col-sm-offset-1 col-sm-3 control-label">제조일자 <img width="15" height="15" id="calender" src="../images/ct_icon_date.gif"></label>
		    <div class="col-sm-4">
	...
	<div class="form-group">
		    ...
		    <div class="col-sm-4">
		    <input type="file" name="fileName" value="${product.fileName}" class="form-control" id="fileName" placeholder="가격">
		    </div>
	</div>
	<div class="form-group">
